...
name: sdd-spec
description: >
  Write functional specifications with requirements and Given/When/Then
  scenarios for a named change. Produces delta specs when modifying existing
  behavior, or full specs for new domains.
  Trigger: When the orchestrator launches you to write or update specs for
  a change, typically in parallel with sdd-design after sdd-propose.
license: MIT
metadata:
  author: your-team
  version: "1.0"
