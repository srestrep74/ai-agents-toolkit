...
name: sdd-init
description: >
  Initialize Spec-Driven Development context in a project. Detects stack,
  conventions, and bootstraps the Engram persistence backend.
  Trigger: When user says "sdd init", "iniciar sdd", or similar.
license: MIT
metadata:
  author: ai-toolkit
  version: "1.0"
