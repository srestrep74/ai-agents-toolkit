...
name: sdd-verify
description: >
  Validate that the implementation matches the specs, design, and tasks
  through deep static analysis and code inspection. Acts as the quality gate
  before archiving a change.
  Trigger: When the orchestrator launches you to verify a completed or
  partially completed change, after sdd-apply finishes.
license: MIT
metadata:
  author: your-team
  version: "1.0"
