...
5.  **MCP Auto-Configuration**: Generates `mcp.json` (Cursor) or `mcp-config.json` (Copilot) with dynamic user paths.
...
2.  **Verify Venv**: Check that a `.venv` folder exists in your project root.
3.  **Test an Agent**: 
